...
namespace contabilidad3
{
    internal class Procedimiento
    {
        ...
        {
            FileInfo file = new FileInfo($"Inventario_{_datos.TituloEmpresa}.xlsx");
            ...
            using (ExcelPackage package = new ExcelPackage(file))
            {
                ...
                worksheet.Cells[$"A{fila + 1}:B{fila+1}"].Style.Border.Top.Style = OfficeOpenXml.Style.ExcelBorderStyle.Double;
                ...
                worksheet.Cells[$"A{fila + 2}:B{fila + 2}"].Style.Border.Top.Style = OfficeOpenXml.Style.ExcelBorderStyle.Double;
                ...
                worksheet.Cells[$"D{fila+1}:E{fila+1}"].Style.Border.Top.Style = OfficeOpenXml.Style.ExcelBorderStyle.Double;


                maxRowCount = Math.Max(_datos.CostosVentasCargos.Count, _datos.CostosVentasAbonos.Count);
                fila = 12;
                ...
                for (int i = 0; i < maxRowCount; i++)
                {
                    if (i < _datos.CostosVentasCargos.Count)
                    {
                        worksheet.Cells[$"G{fila + 1}"].Value = _datos.CostosVentasCargos[i];
                        worksheet.Cells[$"G{fila + 1}"].Style.Border.Right.Style = OfficeOpenXml.Style.ExcelBorderStyle.Thin;
                    }

                    if (i < _datos.CostosVentasAbonos.Count)
                    {
                        worksheet.Cells[$"H{fila + 1}"].Value = _datos.CostosVentasAbonos[i];
                    }
                    fila++;
                }
                ...
                worksheet.Cells["J12"].Value = "Clientes";
                worksheet.Cells[$"J{13}:K{13}"].Style.Border.Top.Style = OfficeOpenXml.Style.ExcelBorderStyle.Thin;
                ...
                worksheet.Cells["A22"].Value = "Pérdidas o Ganancias";
                ...
                {
                    worksheet.Cells[$"A{fila+1}"].Value = _datos.UtilidadesPerdidasCargos[i];
                    worksheet.Cells[$"A{fila+1}"].Style.Border.Right.Style = OfficeOpenXml.Style.ExcelBorderStyle.Thin;
                    fila++;
                }
                fila = 22;
                ...
                {
                    worksheet.Cells[$"B{fila + 1}"].Value = _datos.UtilidadesPerdidasAbonos[i];
                    fila++;
                }
